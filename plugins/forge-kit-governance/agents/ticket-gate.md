...
Run the script that ships with the `ticket-gate-reference` skill. Do NOT re-implement its checks
in prose: they were prose until #149, they are the kit's highest-traffic deterministic surface,
