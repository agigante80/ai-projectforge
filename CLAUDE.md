...
|---|---|---|
| `forge-kit-adapt` | 0.4.3 | skill: adapt |
...
| `forge-kit-governance` | 0.8.1 | agent: ticket-gate; command: gate-ticket; skills: closing-sessions, ticket-gate-reference, working-overnight; hooks: block-dashes, overnight-continue, overnight-guard |
