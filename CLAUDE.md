...
| `forge-kit-governance` | 0.9.8 | agent: ticket-gate; command: gate-ticket; skills: closing-sessions, ticket-gate-reference, working-overnight; hooks: block-dashes, overnight-continue, overnight-guard; shell asset: check-ticket-mechanics |
...
**re-derivation and not a raise**: the file did not grow, the question did.
