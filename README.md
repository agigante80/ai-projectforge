...
| `forge-kit-governance` | agent | `ticket-gate` | v38 | 5489 | Ticket readiness gate - deterministic mechanical checks plus ONE critical-review pass (verdict, per-section pushback, G… |
