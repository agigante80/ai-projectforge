...
| `forge-kit-devops` | skill | `forge-host` | v16 | 1319 | Make governance components forge-host-aware (GitHub or self-hosted Forgejo/Gitea) instead of GitHub-only. |
...
| `forge-kit-devops` | shell asset | `forge-lib` | v6 |  | forge-lib.sh: host-aware forge operations (GitHub \| Forgejo). |
