...
| `forge-kit-governance` | agent | `ticket-gate` | v41 | 5211 | Ticket readiness gate - deterministic mechanical checks plus ONE critical-review pass (verdict, per-section pushback, G… |
...
| `forge-kit-governance` | shell asset | `check-ticket-mechanics` | v1 |  | Step 3A's mechanical checks, as a script rather than as prose for the agent to read. |
