...
|---|---|---|---|---:|---|
| `forge-kit-adapt` | skill | `adapt` | v53 | 7318 | Analyse the current project and recommend the forge-kit components that fit it - subagents, skills, commands, and hooks… |
