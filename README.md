...
|---|---|---|---|---:|---|
| `forge-kit-adapt` | skill | `adapt` | v55 | 7316 | Analyse the current project and recommend the forge-kit components that fit it - subagents, skills, commands, and hooks… |
...
| `forge-kit-governance` | agent | `ticket-gate` | v32 | 5492 | Ticket readiness gate - deterministic mechanical checks plus ONE critical-review pass (verdict, per-section pushback, G… |
...
| `forge-kit-governance` | skill | `ticket-gate-reference` | v1 | 616 | Reference material the ticket-gate agent reads once per run: the review output template it composes, and the specialist… |
