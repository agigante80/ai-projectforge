...
| `forge-kit-governance` | agent | `ticket-gate` | v36 | 5493 | Ticket readiness gate - deterministic mechanical checks plus ONE critical-review pass (verdict, per-section pushback, G… |
