...
|---|---|---|---|---:|---|
| `forge-kit-adapt` | skill | `adapt` | v50 | 7357 | Analyse the current project and recommend the forge-kit components that fit it - subagents, skills, commands, and hooks… |
...
| `forge-kit-devops` | shell asset | `sync-labels` | v6 |  | sync-labels.sh: make the host's labels match `.github/labels.yml`, or report that they do not. |
