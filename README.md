...
| `forge-kit-governance` | agent | `ticket-gate` | v25 | 5715 | Ticket readiness gate - deterministic mechanical checks plus ONE critical-review pass (verdict, per-section pushback, G… |
