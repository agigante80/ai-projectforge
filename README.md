...
| `forge-kit-governance` | agent | `ticket-gate` | v31 | 5406 | Ticket readiness gate - deterministic mechanical checks plus ONE critical-review pass (verdict, per-section pushback, G… |
