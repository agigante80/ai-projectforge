...
| `forge-kit-governance` | agent | `ticket-gate` | v45 | 5209 | Ticket readiness gate - deterministic mechanical checks plus ONE critical-review pass (verdict, per-section pushback, G… |
