...
| `forge-kit-governance` | agent | `ticket-gate` | v39 | 5489 | Ticket readiness gate - deterministic mechanical checks plus ONE critical-review pass (verdict, per-section pushback, G… |
...
| `forge-kit-governance` | skill | `ticket-gate-reference` | v6 | 1054 | Reference material the ticket-gate agent reads once per run: the review output template it composes, the specialist len… |
